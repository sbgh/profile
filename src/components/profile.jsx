...
const Profile = () => {
    ...
    $("body").prepend('<div id="background" class="background"> <img src=' + Mont + ' className="mont" /></div>')
                ...
                <Row>
                    ...
                    <Col className='profileText'>
                        ...
                        <Row className='ProfileBtnRow'>
                            ...
                            <div className='profileTextRow liLink'><a href='https://www.linkedin.com/in/scott-hurd-calgary/' target='_new'>< FaLinkedin className='profileFa' />LinkedIn</a></div>
                            <div className='profileTextRow ghLink'><a href='https://github.com/sbgh' target='_new'>< FaGithub className='profileFa' />GitHub</a></div>
                        </Row>
                    </Col>
                </Row>
            </Container>
