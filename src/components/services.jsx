...
const servicesBlurb = 'Custom coded websites for small and medium sized business. We provide On-line stores, profiles, blogs and more. Amazing looking user experience with capable back-ends. We are flexible, dedicated and focused on your vision.'
...
servicesArrays.push(['Custom WordPress Themes for Unique Brand Identity',
    'We support and integrate with WordPress to align with your brand’s identity and business goals. With a focus on customization, our themes are built to be both visually appealing and functionally robust, ensuring that your eCommerce store stands out in a competitive market.'
])
//8
